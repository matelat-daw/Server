            ...
            <div id="view1" class="profile-dashboard">
                ...
                <div class="dashboard-grid">
                    ...
                    <div class="dashboard-card appointment-card">
                        ...
                        if ($stmt->rowCount() > 0) {
                            ...
                            if ($row->date !== null && $row->time !== null) {
                                ...
                                echo "<a href='turn.php' class='btn-card'>Solicitar Cita</a>";
                            }
                        }
                        ?>
                    </div>
                    ...
                    <div class="dashboard-card actions-card">
                        ...
                        <form action="delete.php" method="post" onsubmit="return confirm('¿Estás seguro de que quieres eliminar tu perfil? Esta acción no se puede deshacer.');">
