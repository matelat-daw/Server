<?php
    ...
    echo '<script>if(!alert("Archivo backup.zip Guardado en la Carpeta del Proyecto.")) window.open("/Barbery/app/auth/index.php", "_self");</script>'; // Muestro una alerta y vuelvo a index.php.
?>