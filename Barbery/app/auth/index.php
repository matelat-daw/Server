                    ...
                    <div id="slide" class="carousel slide" data-bs-ride="carousel">
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img src="../../assets/img/corte.jpg" class="d-block w-100" alt="Corte" width="960px" height="600px">
                            </div>
                            <div class="carousel-item">
                                <img src="../../assets/img/reflex.jpg" class="d-block w-100" alt="Reflejos" width="960px" height="600px">
                            </div>
                            <div class="carousel-item">
                                <img src="../../assets/img/fix.jpg" class="d-block w-100" alt="Arreglo de Barba" width="960px" height="600px">
                            </div>
                            <div class="carousel-item">
                                <img src="../../assets/img/brush.jpg" class="d-block w-100" alt="Peinado" width="960px" height="600px">
                            </div>
                            <div class="carousel-item">
                                <img src="../../assets/img/shave.jpg" class="d-block w-100" alt="Afeitado" width="960px" height="600px">
                            </div>
                            <div class="carousel-item">
                                <img src="../../assets/img/dye.jpg" class="d-block w-100" alt="Color" width="960px" height="600px">
                            </div>
                        </div>
                ...
                <div id="view3">
                    ...
                    <div class="auth-card">
                        ...
                        <form action="/Barbery/api/auth/login.php" method="post">
                            ...
                            </div>                                <div class="form-floating password-wrapper">
                            ...
                            <a href="/Barbery/app/auth/recover.php" class="forgot-link">¿Olvidaste tu contraseña?</a>
                        </div>
                    ...
                    <div class="auth-container" id="registerContainer" style="display: none;">
                        <div class="auth-card" style="max-width: 800px;">
                            ...
                            <form action="/Barbery/api/auth/register.php" method="post" id="registerForm">
                                <div class="row">
