...
?>
<img alt="logo" src="../../assets/img/logo.jpg" height="300" width="100%"/>
<br>
    ...
    <div class="row">
        <div class="col-md-1"></div>
            <div class="col-md-10">
				...
				<form action="/Barbery/app/admin/clients.php" method="post" target="_blank">
				<br>
				...
				<div id="view2">
					...
					<br>
					<form action="/Barbery/api/utilities/export.php" method="post" target="_blank">
				...
				<div id="view3">
					...
					<div class="row">
						<div class="col-md-6">
							...
							<br>
							<form action="/Barbery/app/client/appointments/turnview.php" method="post" target="_blank">
						...
						<div class="col-md-6">
							...
							<br>
							<form action="/Barbery/app/client/appointments/request.php" method="post" target="_blank">
				...
				<div id="view4">
					...
					<div class="row">
						<div class="col-md-6">
							...
							<br>
							<form action="/Barbery/api/services/added.php" method="post" enctype="multipart/form-data" target="_blank">
