...
include $_SERVER['DOCUMENT_ROOT'] . "/Barbery/includes/modal-profile.html";
...
if (!isset($_POST['id']) || !isset($_POST['date']) || !isset($_POST['time'])) {
    ...
    echo "<script>setTimeout(function(){ window.location.href='/Barbery/app/client/appointments/request.php'; }, 2000);</script>";
...
else
{
	...
	echo "<script>setTimeout(function(){ window.location.href='/Barbery/app/client/profile.php'; }, 2000);</script>";
}
