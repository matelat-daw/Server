...
include $_SERVER['DOCUMENT_ROOT'] . "/Barbery/includes/modal-dismiss.html";
...
include $_SERVER['DOCUMENT_ROOT'] . "/Barbery/includes/nav_request.php";
include $_SERVER['DOCUMENT_ROOT'] . "/Barbery/includes/nav-mob-request.php";
?>
                ...
                <br><br><br><br>
                    ...
                    if (isset($_SESSION["client"])) // Aquí entra si está abierta la sesión client.
                    {
                        ...
                        else // Si la fecha se envió vengo del script de administración.
                        {
                            ...
                            echo '<form action="/Barbery/app/client/appointments/turn.php" method="post" id="turnForm" onsubmit="return validateTurnForm()">';
