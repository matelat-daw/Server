...
$router->get("$apiBase/admin/contracts/export/{type}/excel", [ContractController::class, 'exportExcel']);
$router->get("$apiBase/admin/contracts/export/{type}/pdf", [ContractController::class, 'exportPdf']);
