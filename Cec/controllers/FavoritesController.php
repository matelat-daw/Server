...
class FavoritesController extends BaseController {
    ...
    public function checkFavorite($params = []) {
        try {
            ...
            // Devolver directamente el booleano como ASP.NET
    ...
    public function addFavorite($params = []) {
        try {
            ...
            // Devolver booleano directamente como ASP.NET
            header('Content-Type: application/json');
            http_response_code(200);
            echo json_encode($newFavoriteId !== false);
            exit;
    ...
    public function removeFavorite($params = []) {
        try {
            ...
            $success = $this->favoritesRepository->removeFavorite($userId, $constellationId);
