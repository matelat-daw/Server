...
class ConstellationsController extends BaseController {
    ...
    public function getAll($params = []) {
        try {
            error_log("ConstellationsController::getAll - Iniciando");
            
            // Verificar conexión a base de datos
            if (!$this->constellationModel) {
                throw new Exception("Modelo de constelaciones no inicializado");
            }
            
            error_log("ConstellationsController::getAll - Obteniendo constelaciones");
            $constellations = $this->constellationModel->getAll();
            
            if ($constellations === false) {
                throw new Exception("Error al consultar constelaciones en la base de datos");
            }
            
            error_log("ConstellationsController::getAll - " . count($constellations) . " constelaciones obtenidas");
