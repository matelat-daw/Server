...
switch ($uri) {
    ...
    case '/api/Constellations':
        try {
            error_log("Procesando solicitud a /api/Constellations");
            
            // Usar controlador real ahora que la DB funciona
            require_once 'controllers/ConstellationsController.php';
            $controller = new ConstellationsController();
            
            // Mock controller de respaldo (comentado)
            // require_once 'controllers/ConstellationsControllerMock.php';
            // $controller = new ConstellationsControllerMock();
            ...
            error_log("Error en /api/Constellations: " . $e->getMessage());
            CorsHandler::errorResponse("Error interno del servidor: " . $e->getMessage(), 500);
        }
        exit();
